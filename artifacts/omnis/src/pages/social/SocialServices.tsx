    ...
    items: [
      {
        ...
        description:
          "Facilitated multi-year planning processes that align your board, staff, and stakeholders around a coherent theory of change and measurable organizational goals.",
      },
      {
        title: "Funding Diversification",
        description:
          "Audit your current funding mix, identify dependency risks, and build a roadmap to sustainable multi-source revenue — grants, earned income, individual giving, and partnerships.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Design a results framework (log frame, theory of change, MEAL plan) tailored to your programs, with data collection tools your team can actually manage.",
      },
      {
        title: "Reporting & Communication",
        description:
          "Transform raw program data into compelling donor reports, annual reviews, and impact stories that build trust and open doors to new funding.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Strengthen board structure, recruitment, role clarity, and meeting practices so your governing body is an asset to the organization — not a liability.",
      },
      {
        title: "Operational Systems",
        description:
          "Build or refine the HR policies, financial controls, and operational processes that let your team function at scale without burning out.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Custom training programs and coaching for leadership teams, program managers, and frontline staff — grounded in real challenges, not generic workshops.",
      },
      {
        title: "Grant Writing Support",
        description:
          "Expert support crafting proposals to institutional funders, foundations, and government donors — from concept notes to full applications.",
      },
    ],
  },
];
