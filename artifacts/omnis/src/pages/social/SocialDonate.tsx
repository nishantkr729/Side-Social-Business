const causes = [
  {
    ...
    description:
      "Supports grassroots organizations in underserved areas with capacity building grants, helping them develop the internal systems to attract larger funding and serve their communities more effectively.",
  ...
  },
  {
    ...
    description:
      "Enables small nonprofits to access rigorous impact measurement support they could never afford independently — so their programs can be evidence-backed and their stories compellingly told.",
  ...
  },
  {
    ...
    description:
      "Provides leadership training and mentorship for emerging social sector leaders in regions where professional development resources are scarce but mission-driven talent is abundant.",
    impact: "Every $100 contributes to one month of mentorship for an emerging nonprofit leader.",
    tag: "Leadership Development",
  },
];

export default function SocialDonate() {
  return (
