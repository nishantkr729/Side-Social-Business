function SocialAbout() {
  ...
  ].map((stat) => <div key={stat.label} className="bg-white p-8 rounded-2xl border border-green-100 text-center">
  ...
  ].map((val) => <div key={val.title} className="border-t-2 border-green-200 pt-8">
