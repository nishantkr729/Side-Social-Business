    ...
    items: [
      {
        ...
        description:
          "Design a coherent CSR strategy aligned with your business model, sector context, and stakeholder expectations — with clear priorities, resource allocation, and governance.",
      },
      {
        title: "Community Investment Programs",
        description:
          "Structure and launch employee volunteering, skills-based giving, and grant programs that create genuine impact while building team cohesion and brand equity.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Identify the environmental, social, and governance issues most material to your business and stakeholders — the foundation of any credible ESG strategy.",
      },
      {
        title: "Reporting & Disclosure Support",
        description:
          "Navigate GRI, SASB, TCFD, and other reporting frameworks with expert support — from first disclosure to advanced integrated reporting.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Identify and vet the right civil society partners for your programs — organizations with proven track records, strong governance, and alignment with your social objectives.",
      },
      {
        title: "Partnership Design & Management",
        description:
          "Design partnership agreements, accountability frameworks, and joint monitoring systems so that corporate-NGO collaborations deliver on their promise.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Map your stakeholder landscape, prioritize engagement, and design processes for meaningful dialogue — especially with communities directly affected by your operations.",
      },
      {
        title: "Social Impact Measurement",
        description:
          "Build data collection, evaluation, and reporting systems that demonstrate the real social value your business creates — for investors, regulators, and the public.",
      },
    ],
  },
];
