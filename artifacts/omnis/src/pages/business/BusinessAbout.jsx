function BusinessAbout() {
  ...
  ].map((stat) => <div key={stat.label} className="bg-white p-8 rounded-2xl border border-teal-100 text-center">
  ...
  ].map((val) => <div key={val.title} className="border-t-2 border-teal-200 pt-8">
