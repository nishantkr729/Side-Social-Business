...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row min-h-[100dvh] w-full bg-[#0a0a0a]">
      {/* Social Sector Half */}
      <Link href="/social" className="group flex-1 flex flex-col justify-center items-center text-center p-8 md:p-16 border-b md:border-b-0 md:border-r border-white/10 hover:bg-white/5 transition-colors duration-500 cursor-pointer text-white">
      ...
      <Link href="/business" className="group flex-1 flex flex-col justify-center items-center text-center p-8 md:p-16 hover:bg-white/5 transition-colors duration-500 cursor-pointer text-white">
        <div className="max-w-md">
